        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="left-container grey-blue-theme">
                    <div class="text-center left-text" style="margin:20px; padding: 10px 0 10px 0; background-color:#CEFCA3; border-radius: 3px;"><div class="label">盒子</div><div id="boxTemp" style="color: white;font-size: 150%; font-weight: bolder;"><?php echo($D['box_temp']); ?>&nbsp;&#176;C</div></div>
