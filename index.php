    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="left-container grey-blue-theme">
                    <div class="text-center left-text" style="margin:20px; padding: 10px 0 10px 0; background-color:#CEFCA3; border-radius: 3px;"><div class="label">盒子</div><div id="boxTemp" style="color: white;font-size: 150%; font-weight: bolder;"><?php echo($D['home_temp']); ?>&nbsp;&#176;C</div></div>
                    <div class="text-center left-text" style="margin:20px; padding: 10px 0 10px 0; background-color:#CEFCA3; border-radius: 3px;"><div class="label">室温</div><div id="homeTemp" style="color: white;font-size: 150%; font-weight: bolder;"><?php echo($D['home_temp']); ?>&nbsp;&#176;C</div></div>
                    ...
                    <div class="col-md-12">
                        ...
                        for($i = 0; $i<$D['net']['count'];$i++)
                        {
                            ...
                            <div class="row" style="margin: 0;">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2" style="padding: 0;">
                                    <div style="height: 80px; margin-top: 30px; color: white">
                                        <div class="text-center" style="padding: 11px 0 12px 0; "><strong><span id="net-interface-<?php echo($i+1) ?>-name"><?php echo($D['net']['interfaces'][$i]['name']) ?></span></strong></div>
                                        <div class="text-center" style="padding: 10px 0 10px 0; "><span id="net-interface-<?php echo($i+1) ?>-total-in"><?php echo($D['net']['interfaces'][$i]['total_in']) ?></span><br /><small class="label">IN</small></div>
                                        <div class="text-center" style="padding: 10px 0 10px 0;"><span id="net-interface-<?php echo($i+1) ?>-total-out"><?php echo($D['net']['interfaces'][$i]['total_out']) ?></span><br /><small class="label">OUT</small></div>
                                    </div>
                                </div>
                            </div>
